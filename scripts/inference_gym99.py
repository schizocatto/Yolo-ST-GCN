...
Evaluate ST-GCN inference on Gym99-skeleton test split.

Usage
-----
python scripts/inference_gym99.py \
    --dataset_path /path/to/gym99_skeleton.pkl \
    --weights outputs/gym99/stgcn_gym99.pth \
...
def main():
    ...
    if len(data) == 0:
        raise RuntimeError('No test samples found in Gym99 dataset.')
    ...
    with open(os.path.join(args.out_dir, 'metrics_inference_gym99.json'), 'w', encoding='utf-8') as f:
